...
def get_loa4_hierarchy():
    def get_hand_digits(side):
        ...
        for i in range(1, 6):
            ...
            # Simplified digit chain for brevity but structurally correct
...
def export_complex_x3d(filepath, arm_obj, skin_obj, poncho_obj, start_frame, end_frame):
    ...
    for v in mesh.vertices:
        for g in v.groups:
            # Fix: .group attribute for Blender 4.x
            idx = g.group
    ...
    def write_joint(f, bone, indent):
        ...
        # FIX: Root needs 'skeleton', others need 'children' (or default)
        container = "children"
    ...
    with open(filepath, 'w', encoding='utf-8') as f:
        ...
        # FIX: Ensure skinCoord containerField is correct
